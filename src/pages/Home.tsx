  ...
  return (
    <div className="home-desktop-shell">
      ...
      <aside className="home-side-panel">
        <div className="card home-profile home-profile-card">
        ...
        {latestRare ? (
          <div className="card home-rare-card">
          ...
          <div className="card home-rare-card">
            <strong>最近获得的稀有鱼</strong>
            <p style={{ margin: '0.5rem 0 0', color: 'var(--muted)', fontSize: '0.9rem' }}>当前还没有新的稀有鱼解锁，先去刷一条吧。</p>
          </div>
        )}
      </aside>
    </div>
